# Bucket List API - Examples

This folder contains example code for using the Bucket List API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/bucketlist',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/bucketlist");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/bucketlist](https://docs.apiverve.com/ref/bucketlist)
